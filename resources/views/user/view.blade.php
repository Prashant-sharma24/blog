...
@section('content')
<!-- user/view.blade.php -->
@if (session()->has('url') && session()->has('blogPost'))
    @php
        $url = session('url');
    ...
    <!-- Use the $blogPost data as needed -->
@endif
<svg display="none" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <div class="blog-container">
      ...
      <div class="blog-author" >
        <div class="d-flex flex-row" style="display: flex; align-items: center;"><h3 class="mt-8 mb-8">{{ $blogPost->created_at->format('Y-m-d') }}</h3>
        <p> {{ $blogPost->created_at->diffForHumans() }}</p></div>
        {{-- <h3>Russ Beye</h3> --}}
      </div>
      ...
      <div class="blog-body">
        ...
        <a href="{{ $blogPost->url }}">click here to read more related article</a>
      ...
      <div class="blog-footer">
        <div>
            <a href="{{route('user.edit', ['identifier' => $blogPost->unique_identifier])}}"> Edit</a>
        </div>
        <ul>
