...
<script>
   document.addEventListener('DOMContentLoaded', function() {
    var roleRadioButtons = document.getElementsByName('user_role');
    var roleValueInput = document.getElementById('role-value');

    roleRadioButtons.forEach(function(radioButton) {
        radioButton.addEventListener('click', function() {
            if (radioButton.value === '1') {
                roleValueInput.value = 'user';
            } else if (radioButton.value === '2') {
                roleValueInput.value = 'admin';
            }
        });
    });
});
